<div>
    ...
    @endif
        ...
        <div class="card card-md">
          <div class="card-body">
            <h2 class="h2 text-center mb-4">Inicia sesión en tú cuenta</h2>
            <form wire:submit.prevent="LoginHandler()" method="post" autocomplete="off" novalidate="">
              @csrf

              <div class="mb-3">
                <label class="form-label">Usuario</label>
                <input type="text" class="form-control" placeholder="Usuario o correo" autocomplete="off" wire:model="login_id">
                @error('login_id')
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" class="form-control" placeholder="Tú contraseña" autocomplete="off" wire:model="password">
