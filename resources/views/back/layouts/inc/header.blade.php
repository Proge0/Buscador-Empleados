        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <!-- Tu icono y texto para Agregar Empleados -->
              </span>
              <span class="nav-link-title">
                Agregar Empleados
              </span>
          ...
          @if(auth()->user()->rol === 'ADM')
            <li class="nav-item">
              <a class="nav-link" href="{{ route('auth.register')}}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <!-- Tu icono y texto para Agregar Usuario -->
                </span>
                <span class="nav-link-title">
                  Agregar Usuario
                </span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('auth.users')}}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <!-- Tu icono y texto para Usuarios Registrados -->
                </span>
                <span class="nav-link-title">
        ...
        <div class="navbar-nav ms-auto">
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
              <div class="d-xl-none fw-bold">
                <div>{{ auth()->user()->username}}</div>
              </div>
              <div class="d-none d-xl-block ps-2 fw-bold">
                <div>{{ auth()->user()->username}}</div>
              </div>
            </a>
